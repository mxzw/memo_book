...
public class ItemAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (item.getStyle()) {
            case 0:
                holder.style.setBackgroundColor(Color.parseColor("#5eb7b7"));
                holder.title.setTextColor(Color.parseColor("#5eb7b7"));
                break;
            case 1:
                holder.style.setBackgroundColor(Color.parseColor("#fc7978"));
                holder.title.setTextColor(Color.parseColor("#fc7978"));
                break;
            case 2:
                holder.style.setBackgroundColor(Color.parseColor("#ffd369"));
                holder.title.setTextColor(Color.parseColor("#ffd369"));
                break;
            default:
                break;
        }
